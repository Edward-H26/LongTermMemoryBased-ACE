"""
CL-bench Baseline Inference V5: Raw GPT-5.1 (High), no ACE.
...
def main() -> None:
    parser = argparse.ArgumentParser(description = "CL-bench Baseline V5 Inference")
    parser.add_argument("--model", type = str, default = "gpt-5.1")
    parser.add_argument("--output", type = str, default = "benchmark/results/v5/baseline_v5.jsonl")
    ...
    for item in tqdm(pending, desc = "Baseline V5"):
