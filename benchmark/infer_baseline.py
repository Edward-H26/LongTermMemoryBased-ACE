"""
CL-bench Baseline Inference: Raw GPT-5.1 (High), no ACE.

Downloads the tencent/CL-bench dataset from HuggingFace and sends
...
def main():
    ...
    print(f"Loading CL-bench dataset...")
    ...
    for item in tqdm(pending, desc="Baseline Inference"):
        ...
        content, metrics, error = call_api(client, clean_messages, args.model)
